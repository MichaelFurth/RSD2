...
enum InjuredOracle
{
	SAY_ESCORT_FINISHED                 = -1571000,
	SAY_ESCORT_READY                    = -1571001,
	SAY_ESCORT_START                    = -1571002,
...
void AddSC_sholazar_basin()
{
    ...
    pNewScript = new Script;
	pNewScript->Name = "npc_injured_oracle";
	pNewScript->GetAI = &GetAI_npc_injured_oracle;
	pNewScript->pQuestAccept = &QuestAccept_fortunate_misunderstandings;
	pNewScript->pGossipHello = &GossipHello_npc_injured_oracle;
	pNewScript->pGossipSelect = &GossipSelect_npc_injured_oracle;
	pNewScript->RegisterSelf();
